...
class IRL_MaxEnt:
    def __init__(self, n_features, n_states, n_actions, transition, gamma):
        ...
        self.feat_map = np.zeros((self.n_states, 3))
        j = 0
        k = 0
        m = 0
    ...
    def print_final_reward_table(self, grid_width, grid_length):
        print(self.curr_reward_table.reshape((2,grid_width,grid_length))/torch.max(self.curr_reward_table))
